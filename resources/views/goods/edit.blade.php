...
@section('content')
    <div class="offset-3 col-md-6">
        ...
        <form class="bg-dark" method="post" action="{{route('goods.update',$good)}}" enctype="multipart/form-data">
            @method('put')
            @if (count($errors) > 0)
            ...
            <div class="form-group text-white-50">
                ...
                <input class="form-control" type="text" id="input-name" name="name" value="{{$good->name}}"/>
            ...
            <div class="form-group text-white-50">
                ...
                <select class="form-control" id="input-categories-id" name="categories_id"  default="{{$good->categories_id}}">
            ...
            <div class="form-group text-white-50">
                ...
                <select class="form-control" id="input-brand-id" name="brand_id"  default="{{$good->brand_id}}">
            ...
            <div class="form-group text-white-50">
                ...
                <input class="form-control" type="number" id="input-quantity" name="quantity"  value="{{$good->quantity}}"/>
                <span id="input-quantity-error" class="text-danger d-none"><strong>Alert</strong> text.</span>
            </div>
            <div class="form-group text-white-50">
                <label for="input-rate">Rate</label>
                <input class="form-control" type="number" id="input-rate" name="rate"  value="{{$good->rate}}"/>
